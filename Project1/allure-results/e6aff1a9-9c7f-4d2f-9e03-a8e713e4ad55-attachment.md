...
- generic [ref=e2]:
    ...
    - generic [ref=e54]:
      - generic [ref=e55]:
        ...
        - textbox "Email address *" [ref=e57]:
          ...
          - text: jamesSambora123@example.com
      - generic [ref=e58]:
  ...
  - paragraph [ref=e76]:
    ...
    - link "Support this project" [ref=e78] [cursor=pointer]:
      - /url: https://testwithroy.com/b/support
    - text: "|"
    - link "Privacy Policy" [ref=e79] [cursor=pointer]:
      - /url: /privacy
    - text: "| Banner photo by"
    - link "Barn Images" [ref=e80] [cursor=pointer]:
      - /url: https://unsplash.com/@barnimages
    - text: "on"
    - link "Unsplash" [ref=e81] [cursor=pointer]:
