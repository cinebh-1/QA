...
- generic [ref=e2]:
  ...
  - generic [ref=e49]:
    ...
    - generic [ref=e52]:
      ...
      - button "Register" [ref=e114] [cursor=pointer]
  - paragraph [ref=e117]:
    - text: This is a DEMO application (
    - link "GitHub repo" [ref=e118] [cursor=pointer]:
      - /url: https://github.com/testsmith-io/practice-software-testing
    - text: ), used for software testing training purpose. |
    - link "Support this project" [ref=e119] [cursor=pointer]:
      - /url: https://testwithroy.com/b/support
    - text: "|"
    - link "Privacy Policy" [ref=e120] [cursor=pointer]:
      - /url: /privacy
    - text: "| Banner photo by"
    - link "Barn Images" [ref=e121] [cursor=pointer]:
      - /url: https://unsplash.com/@barnimages
    - text: "on"
    - link "Unsplash" [ref=e122] [cursor=pointer]:
